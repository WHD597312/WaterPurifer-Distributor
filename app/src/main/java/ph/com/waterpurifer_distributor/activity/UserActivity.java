...
public class UserActivity extends BaseActivity {
    ...
    @OnClick({R.id.iv_main_memu,R.id.rl_user_cpass,R.id.rl_user_pic})
    ...
    public void startCamera() {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            imageUri = FileProvider.getUriForFile(UserActivity.this, "ph.com.waterpurifer_distributor", imageFile);
        }
